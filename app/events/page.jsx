...
function EventsPage() {
    ...
    useEffect(() => {
        ...
        const title = titleElement
            ...
            : "Empowering Education: How 100 Donations Transformed 2,000+ Lives with Rising Roots Foundation"; // Fallback title
        ...
        document
            ...
            .setAttribute("href", twitterShareLink);
        document
            .getElementById("facebook-share")
            .setAttribute("href", facebookShareLink);
        document
            .getElementById("linkedin-share")
            .setAttribute("href", linkedinShareLink);
                    ...
                    <div className="lg:col-span-2">
                        <div className="py-8 lg:pe-8">
                            <div className="space-y-5 lg:space-y-8">
                                <a
                                    className="inline-flex items-center gap-x-1.5 text-sm text-green-800 decoration-2 hover:underline focus:outline-none hover:underline-offset-2"
                                    href="#"
                                >
                                    <svg
                                ...
                                <h2 className="text-2xl font-semibold-geist lg:text-3xl text-pretty">
                                    How 100 Donations Transformed 2,000+ Lives
                                    with Rising Roots Foundation
                                </h2>

                                <div className="flex items-center gap-x-5">
                                    <a
                                        className="inline-flex items-center gap-1.5 py-1 px-3 sm:py-2 sm:px-4 rounded-xl text-xs sm:text-sm bg-green-800 text-white hover:text-green-800 hover:bg-green-50 focus:outline-none focus:bg-green-50"
                                        href="/donate"
                                    >
                                        Donate
                                    </a>
                                ...
                                <p className="text-l text-gray-800 font-geist">
                                    In a world where education is the key to
                                    unlocking potential, the Rising Roots
                                    Foundation stands as a beacon of hope,
                                    fostering positive change through the power
                                    of community and generosity. Our mission is
                                    simple yet profound: to provide essential
                                    educational resources to those who need them
                                    most, creating a ripple effect of
                                    empowerment that touches lives and
                                    transforms communities.
                                </p>

                                <h3 className="text-2xl font-medium-geist">
                                    Our Impact: Numbers That Tell a Story
                                </h3>
                                <ul className="p-4 border-l-4 list-disc list-outside space-y-5 ps-5 text-l text-gray-800 border-green-800 bg-green-50 rounded-md">
                                    <li>
                                        <strong>
                                            22 Desktop Computers and 2 Printers:
                                        </strong>{" "}
                                        Bridging the digital divide and opening
                                        doors to technological literacy.
                                    </li>
                                    <li>
                                        <strong>5,000+ Sanitary Pads:</strong>{" "}
                                        Ensuring that young girls can attend
                                        school with dignity and confidence.
                                    </li>
                                    <li>
                                        <strong>
                                            12,000+ Exercise Books and 10,000+
                                            Writing Materials:
                                        </strong>{" "}
                                        Providing the basic tools needed for
                                        learning and self-expression.
                                    </li>
                                    <li>
                                        <strong>
                                            830 New Uniforms and Footwear:
                                        </strong>{" "}
                                        Instilling a sense of pride and
                                        belonging among students.
                                    </li>
                                    <li>
                                        <strong>400 Backpacks:</strong> Helping
                                        students carry their dreams and
                                        aspirations along with their books.
                                    </li>
                                    <li>
                                        <strong>500 Crayons:</strong> Nurturing
                                        creativity and bringing color to young
                                        minds.
                                    </li>
                                    <li>
                                        <strong>
                                        ...
                                        Offering life-changing opportunities for
                                        promising students.
                                    </li>
                                </ul>

                                <p className="text-l text-gray-800">
                                    Our efforts have directly impacted over
                                    2,000 pupils, bringing smiles to their faces
                                    and hope to their hearts. But the true
                                    measure of our success lies in the long-term
                                    effects of education on these young lives
                                ...
                                <h3 className="text-xl font-medium-geist">
                                    The Power of 100 Donations
                                </h3>
                                <p className="text-l text-gray-800">
                                    With just 100 donations, we've managed to
                                    create this significant impact. Imagine what
                                    we could achieve with your support. Every
                                    contribution, no matter how small, has the
                                ...
                                <p className="text-l text-gray-800">
                                    The Rising Roots Foundation is more than
                                    just an NGO; we're a community of passionate
                                    individuals committed to making a
                                    difference. By joining us, you become part
                                    of a movement that believes in the
                                ...
                                <aside className="p-4 border-l-4 border-green-800 bg-green-50 rounded-md">
                                    ...
                                    page to learn how you can contribute to this
                                    noble cause. Whether through donations,
                                    volunteering, or spreading awareness, your
                                    involvement can help us reach more children
                                    and create lasting change.
                                </aside>

                                <p className="text-l text-gray-800">
                                    Together, we can nurture the roots of
                                    education and watch as communities rise to
                                    new heights of opportunity and empowerment.
                                    Join the Rising Roots Foundation today, and
                                ...
                                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-y-5 lg:gap-y-0">
                                    <div>
                                        <a
                                            className="m-0.5 inline-flex items-center gap-1.5 py-2 px-3 rounded-xl text-sm bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200"
                                            href="#"
                                        >
                                            #RisingRootsFoundation
                                        </a>
                                        <a
                                            className="m-0.5 inline-flex items-center gap-1.5 py-2 px-3 rounded-xl text-sm bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200"
                                            href="#"
